        ...
        <form onSubmit={(e) => e.preventDefault()} className="mt-4 flex justify-center">
          <div className="relative w-64"> {/* Set a fixed width for the search bar */}
            <input
              type="search"
              id="search"
              className="bg-[#1A1A1A] border border-[#2E2E2E] text-[#f1f1f1] text-sm rounded-full focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 placeholder:text-gray-400"
              placeholder="Search by name or location" // Updated placeholder text
              value={searchQuery}
